...
from .models import User, Notification  # غيّر الاسم لو موديلك مختلف
...
def api_poll(
    ...
    """
    يرجع إشعارات هذا المستخدم التي أُنشئت بعد "since".
    """
    if not user:
        raise HTTPException(status_code=401, detail="Unauthorized")
    # نحول since إلى datetime
